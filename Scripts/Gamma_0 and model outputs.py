...
# In[Load the models]
s = sabs_pkpd.load_model.load_simulation_from_mmt('C:/Users/barraly/Documents/PhD/Sensitivity to initial conditions/Ohara CiPA - analytical voltage - paper.mmt')
s1 = sabs_pkpd.load_model.load_simulation_from_mmt('C:/Users/barraly/Documents/PhD/Sensitivity to initial conditions/tentusscher_2006 - analytical voltage - paper.mmt')
...
init_cond = default[:]
init_cond[3] = 150 # Ki = 150 mM
init_cond[4] = 150 # Kss = 150 mM
s.set_default_state(init_cond)
...
def G0_calc(Ki, Nai, Cai = 0.00010578226860054304, Casr = 3.5556779165585235,
            Cass = 0.00021417287326980984, V=-85.3, Nao = 140, Ko = 5.4, Cao = 2):
...
TT06_low_Ki = np.loadtxt('C:/Users/barraly/Documents/PhD/Sensitivity to initial conditions/initial_conditions_study/WebLab results/Restitution TT06 low Ki.csv',
                         skiprows  = 0,
                         delimiter = ',')

TT06_high_Ki = np.loadtxt('C:/Users/barraly/Documents/PhD/Sensitivity to initial conditions/initial_conditions_study/WebLab results/Restitution TT06 high Ki.csv',
                         skiprows  = 0,
                         delimiter = ',')

ORd_low_Ki = np.loadtxt('C:/Users/barraly/Documents/PhD/Sensitivity to initial conditions/initial_conditions_study/WebLab results/Restitution ORd CiPA low Ki.csv',
                         skiprows  = 0,
                         delimiter = ',')

ORd_high_Ki = np.loadtxt('C:/Users/barraly/Documents/PhD/Sensitivity to initial conditions/initial_conditions_study/WebLab results/Restitution ORd CiPA high Ki.csv',
                         skiprows  = 0,
                         delimiter = ',')
...
#ax[0, 3].legend(fontsize = 25, loc = 'upper left')
